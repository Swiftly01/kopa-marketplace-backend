...
export class AddOtpLogs1778345012414 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."otps_purpose_enum" AS ENUM('email_verification', 'password_reset')`);
        await queryRunner.query(`CREATE TABLE "otps" ("id" SERIAL NOT NULL, "code" character varying NOT NULL, "purpose" "public"."otps_purpose_enum" NOT NULL, "isUsed" boolean NOT NULL DEFAULT false, "expiresAt" TIMESTAMP NOT NULL, "attempts" integer NOT NULL DEFAULT '0', "isBlocked" boolean NOT NULL DEFAULT false, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid, CONSTRAINT "PK_91fef5ed60605b854a2115d2410" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."oauth_accounts_provider_enum" AS ENUM('google', 'apple', 'github')`);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_283c974372e384adfc2c51ae18" ON "oauth_accounts" ("provider", "provider_id") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_baf4ca2a5aa907023a2f3748be" ON "users" ("email_verification_token") `);
        await queryRunner.query(`CREATE INDEX "IDX_17d1817f241f10a3dbafb169fd" ON "users" ("phone_number") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_97672ac88f789774dd47f7c8be" ON "users" ("email") `);
        await queryRunner.query(`CREATE TYPE "public"."password_reset_logs_status_enum" AS ENUM('pending', 'completed')`);
        await queryRunner.query(`CREATE TABLE "password_reset_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid NOT NULL, "token" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "status" "public"."password_reset_logs_status_enum" NOT NULL, "expires_at" TIMESTAMP NOT NULL, "completed_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_5a2466492ed9d71ecb1cdb211cc" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_f01f0067552ab4377ea660cf00" ON "password_reset_logs" ("token") `);
        await queryRunner.query(`CREATE INDEX "IDX_d3bdd60cbf2613e562dc5676b4" ON "password_reset_logs" ("userId", "created_at") `);
        await queryRunner.query(`CREATE TYPE "public"."otp_logs_type_enum" AS ENUM('generate', 'verify_success', 'verify_failed')`);
        await queryRunner.query(`CREATE TYPE "public"."otp_logs_delivery_channel_enum" AS ENUM('email', 'sms')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_afa8768be4cf53168a70da662c" ON "otp_logs" ("user_id", "type") `);
        await queryRunner.query(`CREATE INDEX "IDX_ed045cc5ec0aadf373a2dfee1c" ON "otp_logs" ("user_id", "created_at") `);
        await queryRunner.query(`CREATE TYPE "public"."email_verification_logs_status_enum" AS ENUM('pending', 'verified', 'expired')`);
        await queryRunner.query(`CREATE TABLE "email_verification_logs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "token" character varying(255) NOT NULL, "email" character varying(255) NOT NULL, "status" "public"."email_verification_logs_status_enum" NOT NULL DEFAULT 'pending', "verified_at" TIMESTAMP, "expires_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_c543ff99b383ed6349a5c45f1af" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_a169ea7130edbcec83e8dac8bf" ON "email_verification_logs" ("token") `);
        await queryRunner.query(`CREATE INDEX "IDX_a308ae46f407e7503afffbc282" ON "email_verification_logs" ("user_id", "created_at") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_6a13353ab3b04555733bb62f95" ON "product_images" (" cloudinary_public_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_347673d7b5c70db1f5620273f2" ON "product_images" ("order") `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_77d7eff8a7aaa05457a12b8007" ON "categories" ("code") `);
        await queryRunner.query(`CREATE TYPE "public"."products_status_enum" AS ENUM('draft', 'active', 'inactive', 'removed')`);
        await queryRunner.query(`CREATE TYPE "public"."products_condition_enum" AS ENUM('new', 'like_new', 'good', 'fair')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_6d551dad98cdf98e0488f43703" ON "products" ("seller_id", "status") `);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_9f27a26091871307fd82257512" ON "products" ("location") `);
        ...
        await queryRunner.query(`ALTER TABLE "password_reset_logs" ADD CONSTRAINT "FK_0f3c207d1b0e80b51164b317ad2" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "otp_logs" ADD CONSTRAINT "FK_95c760086ec4292bbbef02dbd12" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "email_verification_logs" ADD CONSTRAINT "FK_77d47d1e9bfd25b777b463c8b95" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "email_verification_logs" DROP CONSTRAINT "FK_77d47d1e9bfd25b777b463c8b95"`);
        await queryRunner.query(`ALTER TABLE "otp_logs" DROP CONSTRAINT "FK_95c760086ec4292bbbef02dbd12"`);
        await queryRunner.query(`ALTER TABLE "password_reset_logs" DROP CONSTRAINT "FK_0f3c207d1b0e80b51164b317ad2"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_9f27a26091871307fd82257512"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_6d551dad98cdf98e0488f43703"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_347673d7b5c70db1f5620273f2"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_6a13353ab3b04555733bb62f95"`);
        await queryRunner.query(`DROP TABLE "product_images"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a308ae46f407e7503afffbc282"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_a169ea7130edbcec83e8dac8bf"`);
        await queryRunner.query(`DROP TABLE "email_verification_logs"`);
        await queryRunner.query(`DROP TYPE "public"."email_verification_logs_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_ed045cc5ec0aadf373a2dfee1c"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_afa8768be4cf53168a70da662c"`);
        await queryRunner.query(`DROP TABLE "otp_logs"`);
        await queryRunner.query(`DROP TYPE "public"."otp_logs_delivery_channel_enum"`);
        await queryRunner.query(`DROP TYPE "public"."otp_logs_type_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_d3bdd60cbf2613e562dc5676b4"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f01f0067552ab4377ea660cf00"`);
        await queryRunner.query(`DROP TABLE "password_reset_logs"`);
        await queryRunner.query(`DROP TYPE "public"."password_reset_logs_status_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_97672ac88f789774dd47f7c8be"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_17d1817f241f10a3dbafb169fd"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_baf4ca2a5aa907023a2f3748be"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_283c974372e384adfc2c51ae18"`);
