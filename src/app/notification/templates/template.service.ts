  ...
  const thumbnailsBlock =
    thumbnails.length > 0
      ? `<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding:14px 24px 0 24px;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr>${thumbnails
          .map(
            (url, i) =>
              `<td width="${Math.floor(100 / thumbnails.length)}%" style="padding:0 6px;"><a href="${productUrl}"><img src="${url}" width="160" alt="${productName} — additional photo ${i + 1}" style="display:block;width:100%;height:auto;border-radius:8px;border:1px solid #eef0f3;"></a></td>`,
          )
...
<td align="center" style="background:linear-gradient(135deg,#16a34a 0%,#0f766e 100%);padding:36px 40px 44px 40px;">
...
<div style="padding-top:14px;font-family:Arial,Helvetica,sans-serif;font-size:26px;line-height:32px;font-weight:800;color:#ffffff;">Something new just landed</div>
...
${thumbnailsBlock}
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding:24px 32px 4px 32px;">
<div style="font-family:Arial,Helvetica,sans-serif;font-size:22px;line-height:28px;font-weight:800;color:#101828;">${productName}</div>
<div style="padding-top:8px;font-family:Arial,Helvetica,sans-serif;font-size:26px;line-height:32px;font-weight:800;color:#16a34a;">${priceDisplay}${discountRow}</div>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" style="padding:26px 32px 8px 32px;">
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding:24px 32px 24px 32px;">
...
<tr><td align="center" style="padding-bottom:16px;">
<a href="${d.facebookUrl ?? '#'}" style="margin:0 8px;"><img src="${SOCIAL_ICON.facebook}" width="20" height="20" alt="Kopa Mart on Facebook" style="border-radius:50%;"></a>
<a href="${d.instagramUrl ?? '#'}" style="margin:0 8px;"><img src="${SOCIAL_ICON.instagram}" width="20" height="20" alt="Kopa Mart on Instagram" style="border-radius:50%;"></a>
<a href="${d.twitterUrl ?? '#'}" style="margin:0 8px;"><img src="${SOCIAL_ICON.twitter}" width="20" height="20" alt="Kopa Mart on X (Twitter)" style="border-radius:50%;"></a>
<a href="${d.whatsappUrl ?? '#'}" style="margin:0 8px;"><img src="${SOCIAL_ICON.whatsapp}" width="20" height="20" alt="Chat with Kopa Mart on WhatsApp" style="border-radius:50%;"></a>
</td></tr>
